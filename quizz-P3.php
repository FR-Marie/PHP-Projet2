...
<body>
    ...
    <div class="text-center">
        <button class="btn-question-precedente rounded"><a href="quizz-P2.php">Précédent</a></button>
    </div>
            ...
            if(isset($_POST["btn-valider"])){
                ...
                if(isset($_POST["reponse3"]) && isset($_POST["reponse4"])){
                    ...
                    <div>
                        ...
                        <button class="question-suivante"><a href="quizz-P4.php">Question suivante</a></button>
                    </div>
