...
<body>
    ...
    <div class="text-center">
        <button class="btn-question-precedente rounded"><a href="quizz.php">Précédent</a></button>
    </div>
    ...
    $tableauAsso = [
        $tableauAsso2 = [
            "question" => "La formation se déroule à...",
            "reponse_1" => "Besançon",
            "reponse_2" => "Dijon",
            "reponse_3" => "La maison",
            "reponse_4" => "Grenoble"
            ...
            if(isset($_POST["btn-valider"])){
                ...
                if(isset($_POST["reponse4"])){
                    ...
                    <div>
                        ...
                        <button class="question-suivante"><a href="quizz-P3.php">Question suivante</a></button>
                    </div>
